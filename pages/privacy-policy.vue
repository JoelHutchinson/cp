<template>
  ...
  <UCard class="w-full">
    ...
    >
      ...
      <div>
        <section class="mt-10">
          <h2 class="text-xl font-semibold mb-2">Ezoic Services</h2>
          <p class="mb-4">
            This website uses the services of
            <strong>Ezoic Inc.</strong> (“Ezoic”), including to manage
            third-party interest-based advertising. Ezoic may employ a variety
            of technologies on this website, including tools to serve content,
            display advertisements, and enable advertising to visitors of this
